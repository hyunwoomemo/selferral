      ...
      >
        {dummyEvent.map((dummy, index) => (
          <SwiperSlide id="event-slide" about="" key={index}>
            <div className="w-full max-w-[155px] md:max-w-[255px]" key={index}>
              {/* <div className="relative w-full"> */}
              {/* <Image className="rounded-lg object-cover" src={dummy.image} fill alt="eventImage" /> */}
              {/* <div className="relative"> */}
              <Image style={{ borderRadius: 20 }} src={dummy.image} className="object-fill w-full max-h-[155px]" alt="eventImage" />
              {/* </div> */}
              {/* </div> */}
