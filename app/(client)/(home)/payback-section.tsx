  ...
  return (
    <div className="md:pt-24 flex flex-col-reverse md:flex-row gap-8 md:gap-28 justify-center items-center ">
      ...
      <div className="flex-1  flex flex-col gap-2 items-center">
        ...
        <h1 className="font-bold text-2xl">셀퍼럴닷컴 이용자님들의</h1>
        <h1 className="font-bold text-2xl ">예상 페이백은</h1>
        <div className="flex justify-center items-end">
          {/* <h1 className="font-bold text-5xl text-orange-400">685,842</h1> */}
          <h1 className="font-bold text-2xl whitespace-nowrap">평균</h1>
          <div
            ref={countUpRef}
            className={`font-bold text-4xl text-orange-400 dark:text-[#c45f00] min-w-40 transition-opacity duration-3000 ${countStart ? "opacity-100" : "opacity-0"} text-center`}
          ></div>
          {/* <CountUp className="font-bold text-5xl text-orange-400 min-w-64" end={685842} duration={2}></CountUp> */}
          <h1 className="font-bold text-2xl whitespace-nowrap">원</h1>
        </div>
        <Button
